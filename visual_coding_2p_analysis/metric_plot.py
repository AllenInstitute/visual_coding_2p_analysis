...
def plot_metric_cre_depth(data_input,area, metric, stimulus_suffix, label, xlim=None):
...
#        plt.xlim(0,1250)#rf area
        ...
        fig.tight_layout()
        figname = r'/Users/saskiad/Documents/CAM/paper figures/'+metric+'_'+area+'_cre'
        save_figure(fig, figname)
        
def plot_metric_box_cre_depth(data_input,area, metric, stimulus_suffix, label, xlim=None):
    '''creates and saves a boxplot of metric for Cre/layers in VISp
...
def plot_metric_fit_cre_depth(data_input,area, metric_fit, label):
    '''creates and saves a violinplot of metric for Cre/layers in VISp
...
#        plt.title("VISp", fontsize=16)
        ...
        plt.axhspan(17.5,19, color='#BDBDBD', alpha=0.4)
        fig.tight_layout()
        figname = r'/Users/saskiad/Documents/CAM/paper figures/'+metric_fit+'_'+area+'_cre'
        save_figure(fig, figname)
...
def plot_metric_cre_depth_dual(data_input,area, metric, label, xlim=None):
    '''creates and saves a violinplot of metric for Cre/layers in VISp
...
def plot_metric_box_cre_depth_dual(data_input,area, metric, label, xlim=None):
    '''creates and saves a boxplot of metric for Cre/layers in VISp
